/*
  INDOR — Junk Removal flow catalog link.
...
USING (VALUES
    (N'moving', N'Moving & Logistics', 5, N'Junk Removal', N'junk-removal', N'fa-dolly', N'tone-blue', N'Administrador', N'JunkRemovalDetails', 2)
...
PRINT 'Junk Removal catalog link updated.';
GO
