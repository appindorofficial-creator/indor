...
BEGIN
    ...
    VALUES
        (@RealtorId, N'Listing', N'Homes', N'MY LISTING', N'listing', N'$589,900', N'1234 Maple Ridge Dr, Charlotte, NC 28211', 589900, 4, 3.5, 2850,
         N'4 Beds · 3.5 Baths · 2,850 sqft', N'/inspeccion3.jpeg', 1.20, 35.189400, -80.790000, N'ACTIVE', N'active', N'View Home', N'#', N'Edit Listing', NULL,
         1, 10),
        ...
        (NULL, N'OpenHouse', N'OpenHouses', N'OPEN HOUSE', N'openhouse', N'Open House This Saturday', N'8921 Providence Rd, Charlotte, NC 28277', NULL, 4, 3, 3100,
         N'4 Beds · 3 Baths · 3,100 sqft', N'/inspeccion5.jpeg', 2.10, 35.055000, -80.770000, N'OPEN HOUSE', N'openhouse', N'View Details', N'#', N'Share', N'#',
         0, 20),
        ...
        (NULL, N'Listing', N'Homes', N'HOME FOR SALE', N'listing', N'Stunning Home in Ballantyne', N'7404 Wallace Ln, Charlotte, NC 28212', 725000, 4, 3.5, 2850,
         N'4 Beds · 3.5 Baths · 2,850 sqft', N'/inspeccion7.jpeg', 1.20, 35.187000, -80.750000, N'NEW', N'new', N'View Listing', N'#', N'I''m Interested', N'#',
         0, 70);
