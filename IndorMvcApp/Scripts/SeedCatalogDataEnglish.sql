...
(4, N'Spotless Home Pro', N'Cleaning service to keep your home in perfect condition, effortlessly.', N'Weekly, biweekly, or monthly', CAST(99.00 AS Decimal(10, 2)), N'USD', N'', 1, CAST(N'2026-05-01T08:23:08.5599716' AS DateTime2), N'Professional cleaning you can see.', N'Enjoy a clean, organized home ready to live in or rent. Our team performs detailed cleanings tailored to your needs. Options: Standard cleaning or Deep cleaning.', N'Surface cleaning|Bathrooms and kitchen|Vacuuming and mopping', N'From', N'Schedule cleaning', N'/limpieza.jpeg');
GO
