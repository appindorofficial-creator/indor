-- =============================================================
-- Re-seed / update IndorDB catalog tables with English content.
--
-- IMPORTANT (Azure / producción con datos de usuarios):
--   NO borra Microservicios, Inspecciones ni Servicios si ya existen
--   (evita error FK_LawnServicioLanding_Microservicios, etc.).
--   Para solo corregir imágenes, ejecute en su lugar:
--     FixServiciosImagenUrl.sql
--     FixInspeccionesImagenUrl.sql
--
-- Este script: INSERT si la tabla está vacía; UPDATE si ya hay filas.
-- =============================================================
...
-- Inspecciones, Microservicios y Servicios: no DELETE (FK + solicitudes de usuarios)
GO
...
-- Servicios: no DELETE (puede haber referencias). INSERT solo si vacío.
GO
...
IF NOT EXISTS (SELECT 1 FROM dbo.Inspecciones)
BEGIN
...
(3, N'Plumbing Inspection', N'Avoid leaks and unnecessary expenses.', N'Water and drainage system evaluation.', N'We identify leaks, inadequate pressure, and hidden damage that can affect the home structure.', N'Pipes|Drains|Water pressure', N'Every 1–2 years', CAST(99.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Inspect plumbing', N'/inspeccion5.jpeg', 1, 4, CAST(N'2026-05-01T08:45:25.5153211' AS DateTime2)),
(4, N'HVAC Inspection', N'Clean air, efficient system.', N'Complete air conditioning system review.', N'We evaluate HVAC performance to ensure efficiency, energy savings, and comfort.', N'AC unit|Filters|General operation', N'Every 6–12 months', CAST(89.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Review air conditioning', N'/inspeccion8.jpeg', 1, 5, CAST(N'2026-05-01T08:45:25.5153211' AS DateTime2)),
...
IF NOT EXISTS (SELECT 1 FROM dbo.Microservicios)
BEGIN
...
ELSE
BEGIN
    UPDATE dbo.Microservicios SET Nombre=N'Safe Air 365', Descripcion=N'Professional air conditioner filter replacement to improve air quality and protect your system.', Frecuencia=N'Every 3 months', Subtitulo=N'Breathe easy. We take care of it.', DescripcionCompleta=N'Keep your home healthy and your system running at 100%. We replace your AC filter quickly and safely, helping reduce dust, allergies, and costly breakdowns.', Incluye=N'Basic system check|Filter replacement|Professional installation', PrecioPrefijo=N'From', CtaTexto=N'Schedule service', ImagenUrl=N'/aire.jpeg' WHERE Id=1;
    UPDATE dbo.Microservicios SET Nombre=N'Always Perfect Lawn', Descripcion=N'Lawn mowing and basic maintenance to keep your property looking great.', Frecuencia=N'Weekly or biweekly', Subtitulo=N'Your home looks better... effortlessly.', DescripcionCompleta=N'We make sure your yard always looks clean, tidy, and professional. Ideal for maintaining property value without losing time.', Incluye=N'Lawn mowing|Basic green area cleanup|Debris collection', PrecioPrefijo=N'From', CtaTexto=N'Book maintenance', ImagenUrl=N'/cesped.jpeg' WHERE Id=2;
    UPDATE dbo.Microservicios SET Nombre=N'Stress-Free Trash', Descripcion=N'We take out your trash and return the bins. Simple, automatic, and worry-free.', Frecuencia=N'1–2 times per week', Subtitulo=N'Never forget collection day again.', DescripcionCompleta=N'Forget fines, bad odors, or missed pickups. We make sure your trash is ready on the right day and return bins to their place.', Incluye=N'Place bins out on pickup day|Return bins to place|Punctual, reliable service', PrecioPrefijo=N'Monthly', CtaTexto=N'Activate service', ImagenUrl=N'/basura.jpeg' WHERE Id=3;
    UPDATE dbo.Microservicios SET Nombre=N'Cleaning Pro', Descripcion=N'Cleaning service to keep your home in perfect condition, effortlessly.', Frecuencia=N'Weekly, biweekly, or monthly', Subtitulo=N'Professional cleaning you can see.', DescripcionCompleta=N'Enjoy a clean, organized home ready to live in or rent. Our team performs detailed cleanings tailored to your needs. Options: Standard cleaning or Deep cleaning.', Incluye=N'Surface cleaning|Bathrooms and kitchen|Vacuuming and mopping', PrecioPrefijo=N'From', CtaTexto=N'Schedule cleaning', ImagenUrl=N'/limpieza.jpeg' WHERE Id=4;
END
GO
...
(2, N'Modern Bath Pro', N'Comfort, style, and value in one space.', N'Complete bathroom remodel with high-quality finishes.', N'We transform your bathroom into a modern, functional, attractive space.', N'Fixture installation|Modern showers|Premium finishes', N'One-time project', CAST(3500.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Renovate bathroom', N'/servicio4.jpeg', 1, 2, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
...
(4, N'Space Expansion', N'More space, more value.', N'Home extensions to increase property size.', N'We create new spaces tailored to your needs: bedrooms, offices, or social areas.', N'Structural design|Full construction|Home integration', N'One-time project', NULL, N'USD', NULL, N'Custom', N'Expand my home', N'/servicio2.jpeg', 1, 4, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
...
(7, N'Air Conditioning Installation', N'Comfort all year round.', N'Professional HVAC system installation.', N'We install efficient AC systems to improve your comfort and energy savings.', N'Full installation|Configuration|Operation testing', N'One-time service', CAST(1500.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Install system', N'/servicio13.jpeg', 1, 7, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
(8, N'Water Heater Pro', N'Hot water without failures.', N'Water heater installation and replacement.', N'Ensure reliable hot water with professional installation.', N'Safe installation|Operation testing|Technical guidance', N'One-time service', CAST(900.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Install water heater', N'/servicio7.jpeg', 1, 8, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
(9, N'Perfect Floors', N'Every step counts.', N'Floor installation and remodeling.', N'We renew your floors with modern, durable materials.', N'Professional installation|Leveling|Quality finishes', N'One-time project', CAST(1800.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Renew floors', N'/servicio8.jpeg', 1, 9, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
(10, N'Professional Interior Painting', N'Refresh without remodeling.', N'Interior painting to quickly transform spaces.', N'Give your home a new look with clean, professional finishes.', NULL, N'One-time service', CAST(800.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Paint interior', N'/servicio11.jpeg', 1, 10, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
(11, N'Premium Exterior Painting', N'Protection and style in one service.', N'Durable, weather-resistant exterior paint.', N'Protect your property from the elements while improving its appearance.', NULL, N'One-time service', CAST(1200.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Paint exterior', N'/servicio10.jpeg', 1, 11, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
(12, N'Home Security', N'Protect what matters most.', N'Smoke detector and basic security system installation.', N'Increase home security with reliable, certified systems.', NULL, N'One-time service', CAST(300.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Install security', N'/priority-smoke-detector.png', 1, 12, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2)),
(13, N'Pro Concrete Driveway', N'Durability you can see.', N'Concrete driveway construction.', N'We design and install durable driveways that improve functionality and aesthetics.', NULL, N'One-time project', CAST(2500.00 AS Decimal(12, 2)), N'USD', N'From', NULL, N'Build driveway', N'/servicio12.jpeg', 1, 13, CAST(N'2026-05-01T08:37:11.7819750' AS DateTime2));
END
ELSE
BEGIN
    UPDATE dbo.Servicios SET Nombre=N'Dream Kitchen', Subtitulo=N'Transform the heart of your home.', Descripcion=N'Complete kitchen remodel with modern, functional design.', DescripcionCompleta=N'We renovate your kitchen to improve aesthetics, functionality, and property value.', Incluye=N'Custom design|Cabinet installation|Modern finishes', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Design my kitchen', ImagenUrl=N'/servicio1.jpeg' WHERE Orden=1;
    UPDATE dbo.Servicios SET Nombre=N'Modern Bath Pro', Subtitulo=N'Comfort, style, and value in one space.', Descripcion=N'Complete bathroom remodel with high-quality finishes.', DescripcionCompleta=N'We transform your bathroom into a modern, functional, attractive space.', Incluye=N'Fixture installation|Modern showers|Premium finishes', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Renovate bathroom', ImagenUrl=N'/servicio4.jpeg' WHERE Orden=2;
    UPDATE dbo.Servicios SET Nombre=N'Total Interior Renovation', Subtitulo=N'Give your home new life.', Descripcion=N'Interior space remodeling for greater comfort and style.', DescripcionCompleta=N'We update your interior spaces with modern, functional solutions.', Incluye=N'Space redesign|Structural improvements|Interior finishes', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Transform interior', ImagenUrl=N'/servicio3.jpeg' WHERE Orden=3;
    UPDATE dbo.Servicios SET Nombre=N'Space Expansion', Subtitulo=N'More space, more value.', Descripcion=N'Home extensions to increase property size.', DescripcionCompleta=N'We create new spaces tailored to your needs: bedrooms, offices, or social areas.', Incluye=N'Structural design|Full construction|Home integration', Frecuencia=N'One-time project', CtaTexto=N'Expand my home', ImagenUrl=N'/servicio2.jpeg' WHERE Orden=4;
    UPDATE dbo.Servicios SET Nombre=N'Impactful Exteriors', Subtitulo=N'First impressions matter.', Descripcion=N'Exterior remodeling to improve aesthetics and value.', DescripcionCompleta=N'We improve your property exterior appearance to increase appeal and market value.', Incluye=N'Facades|Exterior paint|Decorative details', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Improve exterior', ImagenUrl=N'/servicio5.jpeg' WHERE Orden=5;
    UPDATE dbo.Servicios SET Nombre=N'Perfect Patio', Subtitulo=N'Enjoy your home outdoors.', Descripcion=N'Design and construction of functional, modern patios.', DescripcionCompleta=N'We create outdoor spaces ideal for relaxing or sharing with family and friends.', Incluye=N'Custom design|Full construction|Durable finishes', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Build patio', ImagenUrl=N'/servicio6.jpeg' WHERE Orden=6;
    UPDATE dbo.Servicios SET Nombre=N'Air Conditioning Installation', Subtitulo=N'Comfort all year round.', Descripcion=N'Professional HVAC system installation.', DescripcionCompleta=N'We install efficient AC systems to improve your comfort and energy savings.', Incluye=N'Full installation|Configuration|Operation testing', Frecuencia=N'One-time service', PrecioPrefijo=N'From', CtaTexto=N'Install system', ImagenUrl=N'/servicio13.jpeg' WHERE Orden=7;
    UPDATE dbo.Servicios SET Nombre=N'Water Heater Pro', Subtitulo=N'Hot water without failures.', Descripcion=N'Water heater installation and replacement.', DescripcionCompleta=N'Ensure reliable hot water with professional installation.', Incluye=N'Safe installation|Operation testing|Technical guidance', Frecuencia=N'One-time service', PrecioPrefijo=N'From', CtaTexto=N'Install water heater', ImagenUrl=N'/servicio7.jpeg' WHERE Orden=8;
    UPDATE dbo.Servicios SET Nombre=N'Perfect Floors', Subtitulo=N'Every step counts.', Descripcion=N'Floor installation and remodeling.', DescripcionCompleta=N'We renew your floors with modern, durable materials.', Incluye=N'Professional installation|Leveling|Quality finishes', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Renew floors', ImagenUrl=N'/servicio8.jpeg' WHERE Orden=9;
    UPDATE dbo.Servicios SET Nombre=N'Professional Interior Painting', Subtitulo=N'Refresh without remodeling.', Descripcion=N'Interior painting to quickly transform spaces.', DescripcionCompleta=N'Give your home a new look with clean, professional finishes.', Frecuencia=N'One-time service', PrecioPrefijo=N'From', CtaTexto=N'Paint interior', ImagenUrl=N'/servicio11.jpeg' WHERE Orden=10;
    UPDATE dbo.Servicios SET Nombre=N'Premium Exterior Painting', Subtitulo=N'Protection and style in one service.', Descripcion=N'Durable, weather-resistant exterior paint.', DescripcionCompleta=N'Protect your property from the elements while improving its appearance.', Frecuencia=N'One-time service', PrecioPrefijo=N'From', CtaTexto=N'Paint exterior', ImagenUrl=N'/servicio10.jpeg' WHERE Orden=11;
    UPDATE dbo.Servicios SET Nombre=N'Home Security', Subtitulo=N'Protect what matters most.', Descripcion=N'Smoke detector and basic security system installation.', DescripcionCompleta=N'Increase home security with reliable, certified systems.', Frecuencia=N'One-time service', PrecioPrefijo=N'From', CtaTexto=N'Install security', ImagenUrl=N'/priority-smoke-detector.png' WHERE Orden=12;
    UPDATE dbo.Servicios SET Nombre=N'Pro Concrete Driveway', Subtitulo=N'Durability you can see.', Descripcion=N'Concrete driveway construction.', DescripcionCompleta=N'We design and install durable driveways that improve functionality and aesthetics.', Frecuencia=N'One-time project', PrecioPrefijo=N'From', CtaTexto=N'Build driveway', ImagenUrl=N'/servicio12.jpeg' WHERE Orden=13;
END
GO
...
PRINT 'Catalog English update completed (INSERT if empty, UPDATE if rows exist).';
PRINT 'For image-only fixes on Azure, prefer FixServiciosImagenUrl.sql + FixInspeccionesImagenUrl.sql';
GO
