...
BEGIN
    CREATE TABLE dbo.IndorPropertyAdministrators (
        ...
        ToolMaintenanceRequests     BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolMaint DEFAULT (1),
        ToolTurnoverCleaning        BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolClean DEFAULT (1),
        ToolGuestMessaging          BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolMsg DEFAULT (1),
        ToolInvoicesPayments        BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolInv DEFAULT (1),
        ToolDocumentsWarranties     BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolDoc DEFAULT (0),
        ToolServiceProviders        BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolProv DEFAULT (1),
        ToolTeamAccess              BIT              NOT NULL CONSTRAINT DF_IndorPropAdmin_ToolTeam DEFAULT (1),
