(function () {
    function initNotifications() {
        var wrap = document.getElementById('prvNotifyWrap');
        var btn = document.getElementById('prvNotifyBtn');
        var panel = document.getElementById('prvNotifyPanel');
        if (!wrap || !btn || !panel) {
            return;
        }
        ...
        function clearUnreadIndicators() {
            ...
            var badge = document.getElementById('prvNotifyNewBadge');
            if (badge) {
                badge.remove();
            }
        }
