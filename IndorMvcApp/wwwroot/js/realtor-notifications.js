(function () {
    function initNotifications() {
        var wrap = document.getElementById('rlNotifyWrap');
        var btn = document.getElementById('rlNotifyBtn');
        var panel = document.getElementById('rlNotifyPanel');
        if (!wrap || !btn || !panel) {
            return;
        }
        ...
        function clearUnreadIndicators() {
            ...
            var badge = document.getElementById('rlNotifyNewBadge');
            if (badge) {
                badge.remove();
            }
        }
