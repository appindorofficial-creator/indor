...
[Authorize]
public class HoaCommunityController : Controller
{
    private readonly AppDbContext _db;
    private readonly UserManager<ApplicationUser> _userManager;

    public HoaCommunityController(AppDbContext db, UserManager<ApplicationUser> userManager)
    {
        _db = db;
    ...
    public async Task<IActionResult> Index(int id, string? tab)
    {
        ...
        return View(HoaCommunityDisplayService.Build(bundle.Value.Propiedad, bundle.Value.Info, tab));
    }
