...
[Authorize]
public class PropertySnapshotController : Controller
{
    private readonly AppDbContext _db;
    private readonly UserManager<ApplicationUser> _userManager;

    public PropertySnapshotController(AppDbContext db, UserManager<ApplicationUser> userManager)
    {
        _db = db;
    ...
    public async Task<IActionResult> Index(int id, string? tab)
    {
        ...
        return View(PropertySnapshotDisplayService.Build(bundle.Value.Propiedad, bundle.Value.Info, tab));
    }
