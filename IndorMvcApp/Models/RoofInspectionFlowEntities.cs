...
public class RoofInspectionServicioLanding
{
    ...
    public decimal PrecioDesde { get; set; } = 99;

    [MaxLength(120)]
    public string? PrecioTexto { get; set; }

    [MaxLength(500)]
    public string? RecomendacionItems { get; set; }

    [MaxLength(300)]
    public string? RecomendacionIconos { get; set; }
...
public class SolicitudRoofInspection
{
    public int Id { get; set; }
    ...
    [MaxLength(20)]
    public string? EdadTecho { get; set; }
    ...
    public ICollection<ArchivoRoofInspection> Archivos { get; set; } = new List<ArchivoRoofInspection>();
}

[Table("ArchivosRoofInspection")]
public class ArchivoRoofInspection
{
    public int Id { get; set; }
    public int SolicitudRoofInspectionId { get; set; }

    [ForeignKey(nameof(SolicitudRoofInspectionId))]
    public SolicitudRoofInspection? Solicitud { get; set; }
