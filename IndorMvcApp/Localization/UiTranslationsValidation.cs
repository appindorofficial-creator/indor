...
public static class UiTranslationsValidation
{
    public static IEnumerable<KeyValuePair<string, string>> Entries =>
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Enter the AC serial number or toggle \"I don't know\"."] = "Ingresa el número de serie del AC o activa \"No conozco el número de serie\".",
            ["Select the last maintenance date or toggle \"Not sure\"."] = "Selecciona la fecha del último mantenimiento o activa \"No estoy seguro\".",
            ["Last maintenance date cannot be in the future."] = "La fecha del último mantenimiento no puede ser futura.",
