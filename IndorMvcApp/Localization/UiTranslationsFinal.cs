...
public static class UiTranslationsFinal
{
    public static IEnumerable<KeyValuePair<string, string>> Entries =>
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Could not add those photos. Try a JPG or PNG."] = "No se pudieron agregar esas fotos. Prueba con JPG o PNG.",
            ...
            ["Choose how to deliver this report to the homeowner."] =
                "Elige cómo entregar este informe al propietario.",
            ["Choose a report to continue."] = "Elige un informe para continuar.",
            ["Could not send this report. Try again."] = "No se pudo enviar este informe. Inténtalo de nuevo.",
            ["No reports are ready to send yet. Finish a report first, then come back."] =
                "Aún no hay informes listos para enviar. Termina un informe y vuelve.",
            ["Report sent to the homeowner."] = "Informe enviado al propietario.",
            ["Your completion report is ready to review."] = "Tu informe de finalización está listo para revisar.",
            ...
            ["Inspection Findings"] = "Hallazgos de inspección",
            ["Inspection Findings - INDOR PRO"] = "Hallazgos de inspección - INDOR PRO",
            ["Review Findings"] = "Revisar hallazgos",
            ["Select Repair Items"] = "Seleccionar ítems de reparación",
            ["Main and Subpanels, Service and Grounding"] = "Tableros principal y secundarios, servicio y puesta a tierra",
            ["Branch Wiring Circuits, Breakers, and Fuses"] = "Circuitos ramales, breakers y fusibles",
            ...
            ["Lead {0} · {1}"] = "Prospecto {0} · {1}",
            ["Lead link copied."] = "Enlace del prospecto copiado.",
            ["Copy lead link:"] = "Copia el enlace del prospecto:",
            ["Respond within {0} hour"] = "Responde en {0} hora",
            ["Respond within {0} hours"] = "Responde en {0} horas",
            ["Respond within 24 hours"] = "Responde en 24 horas",
            ["Respond within 48 hours"] = "Responde en 48 horas",
            ["Respond within 72 hours"] = "Responde en 72 horas",
            ["Realtor inspection quote request"] = "Solicitud de cotización de inspección de realtor",
            ["Estimate {0}"] = "Cotización {0}",
            ["Timeline"] = "Cronograma",
            ["Warranty"] = "Garantía",
            ...
            ["Single Familiy"] = "Casa unifamiliar",
            ["Condo"] = "Condominio",
            ...
            ["Voice transcript attached"] = "Transcripción de voz adjunta",
            ["Play recording"] = "Escuchar audio",
            ["Pause recording"] = "Pausar audio",
            ["Delete recording"] = "Eliminar audio",
            ["Transcribing…"] = "Transcribiendo…",
            ["Could not transcribe this recording."] = "No se pudo transcribir esta grabación.",
            ["Save draft"] = "Guardar borrador",
            ["Create job only"] = "Solo crear trabajo",
            ["Create job &amp; send quote"] = "Crear trabajo y enviar cotización",
            ["Create job & send quote"] = "Crear trabajo y enviar cotización",
            ...
            ["Roofers typically recommend a visual roof check in spring and fall, and a professional inspection every 1–2 years or after major storms."] =
                "Los techadores suelen recomendar una revisión visual del techo en primavera y otoño, y una inspección profesional cada 1–2 años o después de tormentas fuertes.",
            ...
            ["Cancel this quote request?"] = "¿Cancelar esta solicitud de cotización?",
            ["Request cancelled."] = "Solicitud cancelada.",
            ["Request updated."] = "Solicitud actualizada.",
            ["This quote request could not be cancelled."] = "No se pudo cancelar esta solicitud de cotización.",
            ["This quote request could not be edited."] = "No se pudo editar esta solicitud de cotización.",
            ["Update how providers should receive this request."] = "Actualiza cómo deben recibir los proveedores esta solicitud.",
            ...
            ["{0} repair item"] = "{0} elemento de reparación",
            ...
            // Provider Schedule Visit — late merge so Spanglish/identity in Proveedor cannot win.
            ["Schedule Visit - INDOR PRO"] = "Programar visita - INDOR PRO",
            ["Schedule Visit"] = "Programar visita",
            ["Schedule Verification Visit"] = "Programar visita de verificación",
            ["Visit Type"] = "Tipo de visita",
            ["Verification Visit"] = "Visita de verificación",
            ["Estimate Visit"] = "Visita de cotización",
            ["Inspection Visit"] = "Visita de inspección",
            ["Schedule Date"] = "Fecha de la visita",
            ["Time"] = "Hora",
            ["Assigned Technician"] = "Técnico asignado",
            ["Assign Technician"] = "Asignar técnico",
            ["Priority"] = "Prioridad",
            ["Reminder"] = "Recordatorio",
            ["Send 1 hour before"] = "Enviar 1 hora antes",
            ["Send 2 hours before"] = "Enviar 2 horas antes",
            ["Send 1 day before"] = "Enviar 1 día antes",
            ["Notify homeowner"] = "Notificar al propietario",
            ["Notify Homeowner"] = "Notificar al propietario",
            ["Add to Calendar"] = "Agregar al calendario",
            ["Add this visit to your calendar"] = "Agregar esta visita a tu calendario",
            ["Send visit confirmation to {0}"] = "Enviar confirmación de visita a {0}",
            ["Confirm Visit"] = "Confirmar visita",
            ["Save Draft"] = "Guardar borrador",
            ...
            ["Use a verification visit when photos are not enough to create an accurate estimate."] =
                "Usa una visita de verificación cuando las fotos no bastan para crear un estimado preciso.",
            ["Pressed: Schedule Verification Visit"] = "Pulsado: Programar visita de verificación",
