...
public class EmergencyRoofLeakDetailsViewModel
{
    ...
    public List<ExistingEmergencyRoofLeakFileViewModel> ArchivosExistentes { get; set; } = new();
}

public class ExistingEmergencyRoofLeakFileViewModel
{
