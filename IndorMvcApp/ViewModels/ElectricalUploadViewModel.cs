...
public class ElectricalUploadViewModel
{
    ...
    public List<ExistingElectricalFileViewModel> ArchivosExistentes { get; set; } = new();
}

public class ExistingElectricalFileViewModel
{
